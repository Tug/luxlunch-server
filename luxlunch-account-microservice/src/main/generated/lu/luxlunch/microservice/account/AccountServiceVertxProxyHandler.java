  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "addAccount": {
          service.addAccount(json.getJsonObject("account") == null ? null : new lu.luxlunch.microservice.account.Account(json.getJsonObject("account")),
        ...
        case "updateAccount": {
          service.updateAccount(json.getJsonObject("account") == null ? null : new lu.luxlunch.microservice.account.Account(json.getJsonObject("account")),
                        res -> {
                        if (res.failed()) {
                          if (res.cause() instanceof ServiceException) {
                            msg.reply(res.cause());
