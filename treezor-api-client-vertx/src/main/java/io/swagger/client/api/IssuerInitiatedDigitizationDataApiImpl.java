...
public class IssuerInitiatedDigitizationDataApiImpl implements IssuerInitiatedDigitizationDataApi {

    private ApiClient apiClient;

    public IssuerInitiatedDigitizationDataApiImpl() {
        this(null);
    }

    public IssuerInitiatedDigitizationDataApiImpl(ApiClient apiClient) {
    ...
    public void tavRequestPOST(String accessSignature, String accessTag, Integer accessUserId, String accessUserIp, TreezorBody6 body, Handler<AsyncResult<TreezorInlineResponse20013>> resultHandler) {
        ...
        String localVarPath = "/issuerInitiatedDigitizationDatas";
        ...
        TypeReference<TreezorInlineResponse20013> localVarReturnType = new TypeReference<TreezorInlineResponse20013>() {};
