...
/** @module luxlunch-user-account-js/account_service */
var utils = require('vertx-js/util/utils');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JAccountService = Java.type('lu.luxlunch.microservice.account.AccountService');
var Account = Java.type('lu.luxlunch.microservice.account.Account');
...
var AccountService = function(j_val) {
  ...
  this.addAccount =  function(account, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_accountService["addAccount(lu.luxlunch.microservice.account.Account,io.vertx.core.Handler)"](__args[0]  != null ? new Account(new JsonObject(Java.asJSONCompatible(__args[0]))) : null, function(ar) {
        if (ar.succeeded()) {
          __args[1](null, null);
        } else {
  ...
  this.updateAccount =  function(account, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_accountService["updateAccount(lu.luxlunch.microservice.account.Account,io.vertx.core.Handler)"](__args[0]  != null ? new Account(new JsonObject(Java.asJSONCompatible(__args[0]))) : null, function(ar) {
        if (ar.succeeded()) {
          __args[1](utils.convReturnDataObject(ar.result()), null);
        } else {
          __args[1](null, ar.cause());
...
AccountService._jclass = utils.getJavaClass("lu.luxlunch.microservice.account.AccountService");
