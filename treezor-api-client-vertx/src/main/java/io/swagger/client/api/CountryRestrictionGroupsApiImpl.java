...
public class CountryRestrictionGroupsApiImpl implements CountryRestrictionGroupsApi {

    private ApiClient apiClient;

    public CountryRestrictionGroupsApiImpl() {
        this(null);
    }

    public CountryRestrictionGroupsApiImpl(ApiClient apiClient) {
    ...
    public void deleteCountryRestrictionGroups(Long id, List<String> fields, Handler<AsyncResult<TreezorInlineResponse20011>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling deleteCountryRestrictionGroups"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/countryRestrictionGroups/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
        ...
        TypeReference<TreezorInlineResponse20011> localVarReturnType = new TypeReference<TreezorInlineResponse20011>() {};
    ...
    public void getCountryRestrictionGroups(String accessSignature, String accessTag, Integer accessUserId, String accessUserIp, List<String> fields, String filter, Integer pageNumber, Integer pageCount, String sortBy, String sortOrder, Handler<AsyncResult<TreezorInlineResponse20011>> resultHandler) {
        ...
        // create path and map variables
        String localVarPath = "/countryRestrictionGroups";
    ...
    public void getCountryRestrictionGroupsId(Long id, List<String> fields, Handler<AsyncResult<TreezorInlineResponse20011>> resultHandler) {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling getCountryRestrictionGroupsId"));
            return;
        }
    ...
    public void putCountryRestrictionGroups(Integer id, String accessSignature, String accessTag, Integer accessUserId, String accessUserIp, TreezorBody5 body, Handler<AsyncResult<TreezorInlineResponse20011>> resultHandler) {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling putCountryRestrictionGroups"));
            return;
        }
