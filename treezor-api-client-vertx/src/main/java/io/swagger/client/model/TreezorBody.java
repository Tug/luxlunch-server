...
public class TreezorBody {
  ...
  public TreezorBody tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  **/
  ...
  public TreezorBody userId(Integer userId) {
    this.userId = userId;
    return this;
  }
   ...
   * @return userId
  **/
  @ApiModelProperty(required = true, value = "Beneficiary's userId")
  ...
  public TreezorBody nickName(String nickName) {
  ...
  **/
  ...
  public TreezorBody name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Beneficiary name, linked to bank account.")
  ...
  public TreezorBody address(String address) {
  ...
  **/
  ...
  public TreezorBody iban(String iban) {
    this.iban = iban;
    return this;
  }
  ...
  **/
  ...
  public TreezorBody bic(String bic) {
    this.bic = bic;
    return this;
  }
  ...
  **/
  ...
  public TreezorBody sepaCreditorIdentifier(String sepaCreditorIdentifier) {
  ...
  **/
  ...
  public TreezorBody sddB2bWhitelist(List<TreezorBeneficiariesSddB2bWhitelist> sddB2bWhitelist) {
    this.sddB2bWhitelist = sddB2bWhitelist;
    return this;
  }

  public TreezorBody addSddB2bWhitelistItem(TreezorBeneficiariesSddB2bWhitelist sddB2bWhitelistItem) {
  ...
  **/
  @ApiModelProperty(value = "Each unique mandate reference, with its frequency type, must be explicitely allowed when doing B2B Direct Debit. Furthermore, a mandate not used during more than 36 months will be automatically rejected even if in the white list. If provided, sepaCreditorIdentifier is mandatory.")
  ...
  public TreezorBody sddCoreBlacklist(List<String> sddCoreBlacklist) {
    this.sddCoreBlacklist = sddCoreBlacklist;
    return this;
  }

  public TreezorBody addSddCoreBlacklistItem(String sddCoreBlacklistItem) {
  ...
  **/
  @ApiModelProperty(value = "Core Direct Debit are accepted by default. If a Core mandate is to be refused on reception, it has to be added to this list. If wild char * (star) is used instead of a UMR, all Direct Debit from this beneficiary will be refused. If provided, sepaCreditorIdentifier is mandatory.")
  ...
  public TreezorBody usableForSct(Boolean usableForSct) {
  ...
  **/
  ...
  public TreezorBody fields(List<String> fields) {
    this.fields = fields;
    return this;
  }

  public TreezorBody addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TreezorBody body = (TreezorBody) o;
    return Objects.equals(this.tag, body.tag) &&
        ...
        Objects.equals(this.iban, body.iban) &&
        Objects.equals(this.bic, body.bic) &&
        Objects.equals(this.sepaCreditorIdentifier, body.sepaCreditorIdentifier) &&
        Objects.equals(this.sddB2bWhitelist, body.sddB2bWhitelist) &&
        Objects.equals(this.sddCoreBlacklist, body.sddCoreBlacklist) &&
        Objects.equals(this.usableForSct, body.usableForSct) &&
        Objects.equals(this.fields, body.fields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tag, userId, nickName, name, address, iban, bic, sepaCreditorIdentifier, sddB2bWhitelist, sddCoreBlacklist, usableForSct, fields);
  }
