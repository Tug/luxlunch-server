...
public class Body {
  ...
  **/
  ...
  public Body userId(Integer userId) {
    this.userId = userId;
    return this;
  }
  ...
  **/
  ...
  public Body sepaCreditorIdentifier(String sepaCreditorIdentifier) {
  ...
  **/
  ...
  public Body sddB2bWhitelist(List<BeneficiariesSddB2bWhitelist> sddB2bWhitelist) {
    this.sddB2bWhitelist = sddB2bWhitelist;
    return this;
  }

  public Body addSddB2bWhitelistItem(BeneficiariesSddB2bWhitelist sddB2bWhitelistItem) {
  ...
  **/
  ...
  public Body sddCoreBlacklist(List<String> sddCoreBlacklist) {
    this.sddCoreBlacklist = sddCoreBlacklist;
    return this;
  }

  public Body addSddCoreBlacklistItem(String sddCoreBlacklistItem) {
  ...
  **/
  ...
  public Body usableForSct(Boolean usableForSct) {
  ...
  **/
  ...
  public Body fields(List<String> fields) {
    this.fields = fields;
    return this;
  }

  public Body addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
