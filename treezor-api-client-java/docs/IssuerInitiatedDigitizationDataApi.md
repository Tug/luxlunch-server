...
# **tavRequestPOST**
> InlineResponse20013 tavRequestPOST(accessSignature, accessTag, accessUserId, accessUserIp, body)
...
//import com.treezor.sandbox.api.IssuerInitiatedDigitizationDataApi;
...
try {
    InlineResponse20013 result = apiInstance.tavRequestPOST(accessSignature, accessTag, accessUserId, accessUserIp, body);
...
# **tavrequestget**
> InlineResponse20013 tavrequestget(accessSignature, accessTag, accessUserId, accessUserIp, fields, filter, pageNumber, pageCount, sortBy, sortOrder)
...
try {
    InlineResponse20013 result = apiInstance.tavrequestget(accessSignature, accessTag, accessUserId, accessUserIp, fields, filter, pageNumber, pageCount, sortBy, sortOrder);
    System.out.println(result);
} catch (ApiException e) {
