...
package lu.luxlunch.microservice.account.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link lu.luxlunch.microservice.account.AccountService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(lu.luxlunch.microservice.account.AccountService.class)
public class AccountService {

  public static final io.vertx.lang.rxjava.TypeArg<AccountService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new AccountService((lu.luxlunch.microservice.account.AccountService) obj),
    AccountService::getDelegate
  );

  private final lu.luxlunch.microservice.account.AccountService delegate;
  
  public AccountService(lu.luxlunch.microservice.account.AccountService delegate) {
    this.delegate = delegate;
  }

  public lu.luxlunch.microservice.account.AccountService getDelegate() {
    return delegate;
  }
  ...
  public static AccountService newInstance(lu.luxlunch.microservice.account.AccountService arg) {
